      ...
      subsections: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'RBACDashboard', icon: Shield, label: { en: 'RBAC Dashboard', ar: 'لوحة RBAC' } },
            { name: 'RolePermissionManager', icon: Shield, label: { en: 'Roles & Permissions', ar: 'الأدوار والصلاحيات' } },
            { name: 'RBACAuditReport', icon: AlertCircle, label: { en: 'Security Audit', ar: 'تدقيق الأمان' } },
            { name: 'RBACImplementationTracker', icon: Target, label: { en: 'Implementation Tracker', ar: 'متتبع التنفيذ' } },
            ...
            { name: 'BilingualCoverageReports', icon: Globe, label: { en: 'Bilingual Reports', ar: 'التقارير ثنائية اللغة' }, requireAdmin: true },
            { name: 'FinalImplementationSummary', icon: Award, label: { en: 'Implementation Summary', ar: 'ملخص التنفيذ' }, requireAdmin: true },

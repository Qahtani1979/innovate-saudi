...
function PilotManagementPanel() {
  ...
  // Fetch pilots with visibility rules
  const { data: pilots = [], isLoading } = usePilotsWithVisibility({ limit: 1000 });
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-4 gap-3 mt-3 text-xs">
                      ...
                      <div>
                        ...
                        <p className={`font-medium ${pilot.risk_level === 'high' ? 'text-red-600' :

        ...
        <div dir={isRTL ? 'rtl' : 'ltr'} className={isRTL ? 'text-right' : 'text-left'}>
            <ReactMarkdown
                className={`prose prose-sm max-w-none dark:prose-invert 
                    ...
                    ${isRTL ? 'prose-ul:pr-4 prose-ol:pr-4 prose-ul:pl-0 prose-ol:pl-0' : 'prose-ul:pl-4 prose-ol:pl-4'}
                    ...
                    prose-blockquote:border-primary/30 prose-blockquote:italic prose-blockquote:text-muted-foreground
                    ${isRTL ? 'prose-blockquote:border-r-2 prose-blockquote:pr-3 prose-blockquote:border-l-0 prose-blockquote:pl-0' : 'prose-blockquote:border-l-2 prose-blockquote:pl-3'}
                    ${isRTL ? 'font-arabic' : ''}`}
                components={{
                    ...
                    // Custom list styling for RTL
                    ul: ({ children }) => (
                        <ul className={`list-disc ${isRTL ? 'mr-4' : 'ml-4'}`}>
                            {children}
                        </ul>
                    ),
                    ol: ({ children }) => (
                        <ol className={`list-decimal ${isRTL ? 'mr-4' : 'ml-4'}`}>
                            {children}
                        </ol>
                    )
                }}

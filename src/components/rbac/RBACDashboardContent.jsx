...
export default function RBACDashboardContent() {
  ...
  const { userRoleAssignments, delegations } = useRBACStatistics();
  ...
  return (
    <PermissionGate requireAdmin fallback={<Card className="border-2 border-red-300 bg-red-50">
    ...
    </Card>} children={undefined} permission={undefined} role={undefined}>
      <div className="space-y-6">
        ...
        {/* Visualizers */}
        <PermissionInheritanceVisualizer users={users} roles={roles} delegations={delegations} teams={[]} />

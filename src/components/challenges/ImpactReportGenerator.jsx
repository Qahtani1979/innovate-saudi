...
import { buildImpactReportPrompt, IMPACT_REPORT_SCHEMA } from '@/lib/ai/prompts/challenges';
...
export default function ImpactReportGenerator({ challenge, pilots = [], contracts = [] }) {
  ...
  const generateReport = async () => {
    const result = await invokeAI({
      prompt: buildImpactReportPrompt(challenge, pilots, contracts),
      response_json_schema: IMPACT_REPORT_SCHEMA
    });

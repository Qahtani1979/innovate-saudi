...
import { buildMarketIntelligencePrompt, MARKET_INTELLIGENCE_SCHEMA } from '@/lib/ai/prompts/solutions/marketIntelligence';
...
export default function SolutionMarketIntelligence({ solution }) {
  ...
  const fetchIntelligence = async () => {
    const response = await invokeAI({
      prompt: buildMarketIntelligencePrompt(solution),

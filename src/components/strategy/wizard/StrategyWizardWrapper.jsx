...
import {
  getStep1Prompt, step1Schema,
  getStep2Prompt, step2Schema,
  getStep3Prompt, step3Schema,
  getStep4Prompt, step4Schema,
  getStep5Prompt, step5Schema,
  getStep6Prompt, step6Schema,
  getStep7Prompt, step7Schema,
  getStep8Prompt, step8Schema,
  getStep9Prompt, step9Schema,
  getStep10Prompt, step10Schema,
  getStep11Prompt, step11Schema,
  getStep12Prompt, step12Schema,
  getStep13Prompt, step13Schema,
  getStep14Prompt, step14Schema,
...
export default function StrategyWizardWrapper() {
  ...
  const generateForStep = async (step) => {
    ...
    const prompts = {
      context: getStep1Prompt(context),
      vision: getStep2Prompt(context, wizardData),
      stakeholders: getStep3Prompt(context),
      pestel: getStep4Prompt(context, wizardData),
      swot: getStep5Prompt(context, wizardData),
      scenarios: getStep6Prompt(context, wizardData),
      risks: getStep7Prompt(context, wizardData),
      dependencies: getStep8Prompt(context, wizardData),
      objectives: getStep9Prompt(context, wizardData),
      national: getStep10Prompt(context, wizardData),
      kpis: getStep11Prompt(context, wizardData),
      actions: getStep12Prompt(context, wizardData),
      resources: getStep13Prompt(context, wizardData),
      timeline: getStep14Prompt(context, wizardData),
      governance: getStep15Prompt(context, wizardData),
      communication: getStep16Prompt(context, wizardData),
      change: getStep17Prompt(context, wizardData)
    };
    
    // Build schemas from imported schema definitions
    const schemas = {
      context: step1Schema,
      vision: step2Schema,
      stakeholders: step3Schema,
      pestel: step4Schema,
      swot: step5Schema,
      scenarios: step6Schema,
      risks: step7Schema,
      dependencies: step8Schema,
      objectives: step9Schema,
      national: step10Schema,
      kpis: step11Schema,
      actions: step12Schema,
      resources: step13Schema,
      timeline: step14Schema,
      governance: step15Schema,
      communication: step16Schema,
      change: step17Schema
    };

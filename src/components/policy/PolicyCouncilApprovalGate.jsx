...
import { CheckCircle2, Users, FileText, DollarSign, Presentation, Upload } from 'lucide-react';
  ...
  const handleCouncilDecision = async (decisionType) => {
    ...
    if (decisionType === 'approved') {
      await updatePolicyMutation.mutateAsync({
        workflow_stage: 'council_approved'
      });
    }
  };
        ...
        <>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                onClick={() => updatePolicyMutation.mutate({ council_presentation_notes: presentationNotes })}
                className="w-full"
              >

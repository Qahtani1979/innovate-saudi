...
export const CHALLENGE_PRIORITIES = ['low', 'medium', 'high', 'critical'];
...
/** @typedef {z.infer<typeof challengeBaseSchema>} ChallengeBase */
/** @typedef {z.infer<typeof challengeCreateSchema>} ChallengeCreate */
/** @typedef {z.infer<typeof challengeSubmitSchema>} ChallengeSubmit */
/** @typedef {z.infer<typeof challengeReviewSchema>} ChallengeReview */
/** @typedef {z.infer<typeof challengeStatusUpdateSchema>} ChallengeStatusUpdate */
/** @typedef {z.infer<typeof challengeTransferSchema>} ChallengeTransfer */
/** @typedef {z.infer<typeof challengeBulkOperationSchema>} ChallengeBulkOperation */
/** @typedef {z.infer<typeof challengeFilterSchema>} ChallengeFilter */

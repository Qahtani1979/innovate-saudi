...
Current Projects: ${sandbox.current_projects || 0}
Utilization: ${((sandbox.current_projects || 0) / (sandbox.capacity || 1) * 100).toFixed(0)}%
Success Rate: ${sandbox.success_rate || 'N/A'}%
Available Exemptions: ${sandbox.exemptions_granted?.length || 0}

...
export const SIDEBAR_MENUS = {
  admin: {
    ...
    items: [
      ...
      { name: 'ApplicationReviewHub', icon: ClipboardList, label: { en: 'Application Review', ar: 'مراجعة الطلبات' } },
      { name: 'MatchmakerEvaluationHub', icon: Link2, label: { en: 'Matchmaker Evaluation', ar: 'تقييم المطابقة' } },
      { name: 'ProgramApplicationEvaluationHub', icon: FileCheck, label: { en: 'Program Evaluation', ar: 'تقييم البرامج' } },
      { name: 'MentorshipHub', icon: GraduationCap, label: { en: 'Mentorship Hub', ar: 'مركز الإرشاد' } },
      { name: 'CollaborationHub', icon: Handshake, label: { en: 'Collaboration Hub', ar: 'مركز التعاون' } },
      ...
      { name: 'StrategicCommunicationsHub', icon: MessageSquare, label: { en: 'Strategic Communications', ar: 'الاتصالات الاستراتيجية' } },
      { name: 'ProgramCampaignHub', icon: Rocket, label: { en: 'Program Campaigns', ar: 'حملات البرامج' } },
      { name: 'ChallengesHub', icon: Target, label: { en: 'Challenges Hub', ar: 'مركز التحديات' } },
      ...
      { name: 'ConversionHub', icon: TrendingUp, label: { en: 'Conversion Hub', ar: 'مركز التحويل' } },
  ...
  executive: {
    ...
    items: [
      ...
      { name: 'ChallengesHub', icon: Target, label: { en: 'Challenges Hub', ar: 'مركز التحديات' }, permission: 'challenge_view' },
      { name: 'Challenges', icon: AlertCircle, label: { en: 'Challenges', ar: 'التحديات' } },
      { name: 'Pilots', icon: TestTube, label: { en: 'Pilots', ar: 'التجارب' } },
  ...
  citizen: {
    ...
    items: [
      ...
      { name: 'CitizenLivingLabParticipation', icon: TestTube, label: { en: 'My Lab Projects', ar: 'مشاريعي البحثية' } },
      { name: 'CitizenRewardsCenter', icon: Gift, label: { en: 'Rewards Center', ar: 'مركز المكافآت' } },
      { name: 'CitizenCommunityForum', icon: MessageSquare, label: { en: 'Community Forum', ar: 'منتدى المجتمع' } },
      { name: 'CitizenFeedbackHub', icon: MessageSquare, label: { en: 'Feedback Hub', ar: 'مركز الملاحظات' } },

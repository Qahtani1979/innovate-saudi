...
export const SIDEBAR_MENUS = {
  ...
  municipality: {
    ...
    items: [
      ...
      { name: 'ChallengeCreateWizard', icon: AlertCircle, label: { en: 'Create Challenge', ar: 'إنشاء تحدي' } },
      { name: 'PilotCreateWizard', icon: TestTube, label: { en: 'Create Pilot', ar: 'إنشاء تجربة' } },
